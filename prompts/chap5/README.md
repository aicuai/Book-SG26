...
**Seedance 2.0 (R2V)「リズメイの待ち合わせ」**（15秒）

渋谷のハチ公前で待ち合わせる響姫メイと渋谷リズを描いた15秒のCM風動画です。生成に使用したプロンプトは [5-4-5](#5-4-5) を参照してください。

▶️ [Seedance2.0_R2V‗Movie_720p_SAMPLE.mp4](Seedance2.0_R2V%E2%80%97Movie_720p_SAMPLE.mp4)
